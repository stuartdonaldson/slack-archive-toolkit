...
def build_parser() -> argparse.ArgumentParser:
    ...
    from . import backup, catalog, channel, channel_digest, dm, export, files, search, workspace

    for module in (workspace, channel, dm, catalog, backup, export, files, search, channel_digest):
